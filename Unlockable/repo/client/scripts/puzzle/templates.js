define(['ember'], function(Ember){Ember.TEMPLATES["Puzzle"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
...
Ember.TEMPLATES["PuzzleGame"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [3,'>= 1.0.0-rc.4'];
helpers = helpers || Ember.Handlebars.helpers; data = data || {};
...
Ember.TEMPLATES["PuzzleInstructions"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [3,'>= 1.0.0-rc.4'];
helpers = helpers || Ember.Handlebars.helpers; data = data || {};
  var buffer = '', hashTypes, hashContexts, escapeExpression=this.escapeExpression;


  data.buffer.push("<div class=\"unlockable-screen puzzle-instructions-screen\">\n  <div class=\"banner instructions\">Instructions</div>\n  <h1 class=\"headline\">Puzzle</h1>\n  <h4 class=\"descriptor\">Connect all the pieces before the video ends!</h4>\n  <div class=\"instructions-image-wrapper\">\n    <div class=\"instructions-tile-image\"></div>\n  </div>\n</div>\n\n<a ");
  hashTypes = {};
  hashContexts = {};
...
Ember.TEMPLATES["PuzzlePerformance"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [3,'>= 1.0.0-rc.4'];
helpers = helpers || Ember.Handlebars.helpers; data = data || {};
...
function program1(depth0,data) {
  ...
  data.buffer.push(escapeExpression(helpers.bindAttr.call(depth0, {hash:{
    'data-stars': ("Unlockable.router.puzzleController.stars"),
    'class': (":unlockable-screen :complete-screen")
  },contexts:[],types:[],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push(">\n    <div class=\"banner complete\"><span class=\"gameName\">PUZZLE</span><br>COMPLETE!</div>\n    <ul class=\"stars\">\n      <li class=\"star star-1 fadeInUp\"></li>\n      <li class=\"star star-2 fadeInUp\"></li>\n      <li class=\"star star-3 fadeInUp\"></li>\n    </ul>\n    <h1 class=\"headline\">");
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "Unlockable.router.puzzleController.score", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push("</h1>\n    <table class=\"descriptor\">\n      <tbody>\n        <tr>\n          <td>ACCURACY</td>\n          <td>+");
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "Unlockable.router.puzzleController.accuracyPoints", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push("</td>\n          <td class=\"trys\">");
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "Unlockable.router.puzzleController.answersRight", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push(" correct</td>\n        </tr>\n        <tr>\n          <td>TIME</td>\n          <td>+");
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "Unlockable.router.puzzleController.timePoints", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push("</td>\n          ");
  hashTypes = {};
  hashContexts = {};
  stack1 = helpers['if'].call(depth0, "Unlockable.router.puzzleController.gotMaxTimePoints", {hash:{},inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  ...
  data.buffer.push(escapeExpression(helpers.view.call(depth0, "Unlockable.OfferWindowView", {hash:{
    'contentBinding': ("Unlockable.router.puzzleController")
  },contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push("\n\n  <div class=\"prize\">\n    <div class=\"coinstack\"></div>\n    <div class=\"lock\">\n      <div class=\"lock-top\"></div>\n      <div class=\"lock-bottom\"></div>\n    </div>\n  </div>\n\n</div>\n");
  return buffer;
  
});
Ember.TEMPLATES["PuzzleRound"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [3,'>= 1.0.0-rc.4'];
helpers = helpers || Ember.Handlebars.helpers; data = data || {};
  var buffer = '', hashContexts, hashTypes, escapeExpression=this.escapeExpression;
  ...
  data.buffer.push(escapeExpression(helpers.view.call(depth0, "Unlockable.PuzzleVideoView", {hash:{
    'sourcesBinding': ("content.sources")
  },contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  data.buffer.push("\n");
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers.view.call(depth0, "Unlockable.PuzzleGameView", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
  return buffer;
  
});
Ember.TEMPLATES["PuzzleVideo"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [3,'>= 1.0.0-rc.4'];
helpers = helpers || Ember.Handlebars.helpers; data = data || {};
  var buffer = '', stack1, hashTypes, hashContexts, escapeExpression=this.escapeExpression, self=this;
